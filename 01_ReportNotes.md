...
###
    ✔️ Стан абонентського порту - UP ✔️ Обмін MAC-adders присутній
    ❓ Абонент не пінгується через політики безпеки 
    ❓ через те що абонент включений до фейк-точки яка включена в обладнання 
       дистрибуції-агрегації не можна бути впевненим, 
       що мас адреса абонента присутня на інтерфейсі
       додайте мас-адресу (якщо це можливо) для подальшої перевірки 
